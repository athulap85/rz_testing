Feature: refdata add for position tests
  ...
  Scenario: TC_001 Copy & create new Participants for Position Testing
    ...
    And instance "RZ-Base-Firm-1" of entity "Participants" is copied with following values
      | Instance ID | Participant Id | Name     | Type   |
  ...
  Scenario: TC_002 Copy & create new Position Keys for Position Testing
    ...
    Given instance "RZ-Base-Pos-Key-01" of entity "Position Keys" is copied with following values
    ...
    And instance "RZ-Base-Pos-Key-01" of entity "Position Keys" is copied with following values
