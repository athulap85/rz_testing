...
Scenario: TC_002 Create risk portfolio with already existing Risk Portfolio ID
    When instance of entity "Risk Portfolios" is created with following values
      | Instance ID | Risk Portfolio Id  | Risk Measure             | Holding Period    |Risk Measure Multiplier|Hedge Risk Factor|Rf Value|Hedge Instrument|
      | RISK01      | RP_001             | FLAT                     | 1                 | 1                     | DV01            |1000    |FVX01           |
...
Scenario: TC_003 Create risk portfolio without risk portfolio id
    When instance of entity "Risk Portfolios" is created with following values
      | Instance ID |  Risk Measure             | Holding Period    |Risk Measure Multiplier|Hedge Risk Factor|Rf Value|Hedge Instrument|
      | RISK02      |  FLAT                     | 1                 | 1                     | DV01            |1000    |FVX01           |
    Then the request should be rejected with the error "Risk Portfolio Id is Required."

Scenario: TC_004 Create risk portfolio without Risk Measure
    When instance of entity "Risk Portfolios" is created with following values
      | Instance ID | Risk Portfolio Id  | Holding Period    |Risk Measure Multiplier|Hedge Risk Factor|Rf Value|
      | RISK02      |  RP_002            | 1                 | 1                     | DV01            |1000    |
    Then the request should be rejected with the error "Risk Measure is Required."
...
Scenario: TC_006 Create risk portfolio without Holding Period
    When instance of entity "Risk Portfolios" is created with following values
      | Instance ID | Risk Portfolio Id  | Risk Measure             | Risk Measure Multiplier|Hedge Risk Factor|Rf Value|
      | RISK02      |  RP_002            |  FLAT                    |  1                     | DV01            |1000    |
    Then the request should be rejected with the error "Holding period valid value is greater than zero."
...
Scenario: TC_012 Update the Risk Measure in an existing Risk Portfolio
    Given instance "RP_001" of entity "Risk Portfolios" is updated with following values
...
Scenario: TC_017 Update the multiple fields in an existing Risk Portfolio
    Given instance "RP_001" of entity "Risk Portfolios" is updated with following values
      | Instance ID | Risk Measure    |Holding Period|Holding Period Multiplier|Risk Measure Multiplier|Hedge Risk Factor|Flat Rate|Rf Value |
      | RISK01      | FLAT            |5             |                         |                       |DV01             |         |         |
    And instance "RP_001" of entity "Risk Portfolios" is deleted